...
if(isset($_POST['adddata'])){
    ...
    $insertquery = $Controller->createDepartmentComponent($department);
...
$readquery = $Controller->readDepartmentComponent();
    ...
    <div class="pagetitle">
      ...
      <nav>
        ...
        <div class="btn-group me-2">
            <button  class="btn btn-sm btn-primary fw-bold"  data-bs-toggle="modal" data-bs-target="#adminAdd">ADD DEPARTMENT  <i class="bi bi-building"></i> </button>
          </div>
      </nav>
    </div><!-- End Page Title -->
...
<td>
  <a href="add-department.php?deletedata=<?php echo $row['id'];?>" class="text-white mr-2 text-decoration-none btn btn-danger btn-sm" onclick="return confirm('Do you want to remove this data?')";
    title="Delete"><i class="bi bi-trash"></i> </a>
    <a href="edit-department.php?editdata=<?php echo $row['id'];?>" class="text-white mr-2 text-decoration-none btn btn-success btn-sm" onclick="return confirm('Do you want to edit this data?')";
	...
	<div class="modal-dialog modal-md">
	  <div class="modal-content">
		<div class="modal-header">
		  <h5 class="modal-title text-uppercase"><strong> Add Department Portal </strong> <i class="bi bi-building"></i></h5>
		</div>
