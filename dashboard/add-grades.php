...
if(isset($_POST['adddata'])){
    ...
    $insertquery = $Controller->insertGrade($grade,$course,$student,$semester);
   
  if($insertquery){

    $_SESSION['status'] = "Student Grade successfully inserted!";
    $_SESSION['type'] = "success";

  }else{
    $_SESSION['status'] = "Failed to insert student grade!";
    $_SESSION['type'] = "error";
  }
...
$readquery = $Controller->readGrade();
...
if (isset($_GET['deletedata'])){
  ...
  $id = $_GET['deletedata'];
  $table = 'tblgrades';
  $deletequery = $Controller->deleteGrade($id);
    ...
    <div class="pagetitle">
      ...
      <nav>
        ...
        <div class="btn-group me-2">
            <button  class="btn btn-sm btn-primary fw-bold"  data-bs-toggle="modal" data-bs-target="#adminAdd">ADD GRADE  <i class="bi bi-building"></i> </button>
          </div>
      </nav>
    </div><!-- End Page Title -->
...
<td>
  <a href="add-grades.php?deletedata=<?php echo $row['gradeid'];?>" class="text-white mr-2 text-decoration-none btn btn-danger btn-sm" onclick="return confirm('Do you want to remove this data?')";
    title="Delete"><i class="bi bi-trash"></i> </a>
    <a href="edit-course.php?editdata=<?php echo $row['gradeid'];?>" class="text-white mr-2 text-decoration-none btn btn-success btn-sm" onclick="return confirm('Do you want to edit this data?')";
