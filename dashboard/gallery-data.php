...
if(isset($_POST['adddata'])){
    ...
    $image_tempname = $_FILES['image']['tmp_name'];
      ...
      $root_path = "../assets/images/gallery/".$image; // storing image path to folder in root directory
      $db_path = "assets/images/gallery/".$image; // storing image path into database
