...
if (isset($_SESSION['role']) && $_SESSION['role'] == "Departmentadmin"){
  
  $department = $_SESSION['department'];
  $readquery = $Controller->readDepartmentLecturerOnly($department); 
   
}else {

$readquery = $Controller->readLecturerOnly();
